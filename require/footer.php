<footer class="text-center">
    <p>
        <img src="https://protege-moi-sur-internet.com/images/moi.jpg" class="img-thumbnail" width="36" height="36" alt="">
    ...
    <ul class="list-inline">
        ...
        <li class="list-inline-item"><a href="https://github.com/YannJaulin" target="_blank"><i class="fa fa-github" aria-hidden="true"></i> GitHub</a></li>
        <li class="list-inline-item"><a rel="me" href="https://octodon.social/@Reallysecuretools" target="_blank"><i class="fa fa-mastodon" aria-hidden="true"></i> Mastodon</a></li>
