...
<html lang="fr">
  <head>
   ...
   <!-- Title -->
   <title>Protège-moi sur Internet - Erreur 404</title>
        ...
        <div class="col-md">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Erreur 404</li>
            </ol>
          </nav>
        </div>
    </div>
  ...
  <div class="py-4"></div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md">
                <!-- Titre -->
                <h1 class="font-weight-bold text-center">Erreur 404</h1>

                <!-- Séparateur -->
                <div class="py-4"></div>

                <!-- Présentation -->
                <p class="lead text-center">La page que vous essayez de voir n'existe pas !</p>
